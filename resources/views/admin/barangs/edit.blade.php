            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-medium mb-4">{{ __('Edit Item') }}</h3>
                        ...
                        <form method="POST" action="{{ route('admin.barang.update', $barang->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                <label for="stok" :value="__('Stok')" class="text-black">Stock</label>
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Leave blank if you don't want to change the photo</p>
