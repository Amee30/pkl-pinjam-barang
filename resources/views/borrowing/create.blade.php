            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('pinjam.store') }}">
                        ...
                        <div class="mb-6">
                            <h3 class="text-lg font-medium mb-2">Item Details</h3>
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Category: {{ $barangs->kategori }}</p>
                                    <p class="text-sm text-gray-600">Serial Number: {{ $barangs->serial_number ?? 'No Serial Number' }}</p>
                                    <p class="text-sm text-gray-600">Available Stock: {{ $barangs->stok }}</p>
                                </div>
                            </div>
                        </div>
                        
                        <div class="mb-4">
                            <label for="return_due_date" :value="__('Tanggal Pengembalian')" class="text-black">Date Returning</label>
                        ...
                        <div class="mb-4">
                            <label for="reason" :value="__('Tujuan Peminjaman')" class="text-black">Purpose of Borrowing</label>
