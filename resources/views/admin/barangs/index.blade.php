<x-admin-layout>
                    ...
                    <div class="p-4 sm:p-6 text-gray-900">
                        ...
                        <div class="flex flex-col gap-4 mb-4 sm:mb-6">
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                                <h3 class="text-lg sm:text-xl font-medium">Item List</h3>
                                
                                <!-- Add Item Button - Mobile First -->
                                <a href="{{ route('admin.barang.create') }}" 
                                   class="inline-flex items-center justify-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm sm:text-base transition-colors w-full sm:w-auto">
                            ...
                            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                                <label for="categoryFilter" class="text-sm font-medium text-gray-700 whitespace-nowrap sm:min-w-fit">
                                    Filter:
                                </label>
                                <form method="GET" action="{{ route('admin.barang.index') }}" id="filterForm" class="flex items-center gap-2 flex-1">
                                    <select 
                                        ...
                                        class="flex-1 sm:flex-none border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm py-2 px-3 sm:min-w-[200px]">
                        ...
                        <div class="lg:hidden space-y-4">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                ...
                                <div class="mb-3 pb-3 border-b border-gray-200">
                                    <h4 class="text-base font-semibold text-gray-900 break-words mb-2 text-center">{{ $barang->nama_barang }}</h4>
                                    <div class="flex justify-center">
                                ...
                                <!-- Stock -->
                                <div class="mb-3 pb-3 border-b border-gray-200">
                                    <p class="text-xs text-gray-500 mb-1 text-center">Stock</p>
                                    <div class="flex justify-center">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <button type="button" 
                                        onclick="showModal('{{ $barang->id }}')"
                                        class="flex-1 min-w-[calc(50%-0.25rem)] inline-flex items-center justify-center px-3 py-2 bg-blue-500 text-white text-xs font-semibold rounded-lg hover:bg-blue-700 transition-colors">
                                    ...
                                    <a href="{{ route('admin.barang.edit', $barang->id) }}" 
                                       class="flex-1 min-w-[calc(50%-0.25rem)] inline-flex items-center justify-center px-3 py-2 bg-indigo-500 text-white text-xs font-semibold rounded-lg hover:bg-indigo-700 transition-colors">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>
                                        Edit
    ...
    <div id="detailModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-4 sm:top-20 mx-auto p-4 sm:p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white my-4">
            <div class="flex flex-col">
                <div class="flex justify-between items-center pb-3 sm:pb-4 border-b mb-3 sm:mb-4">
                    <h3 class="text-lg sm:text-xl font-medium text-gray-900" id="modalTitle">Item Details</h3>
                    <button class="text-gray-400 hover:text-gray-500 p-1" onclick="closeModal()">
                ...
                <div id="modalLoading" class="text-center py-8">
                    ...
                    <p class="mt-2 text-sm sm:text-base text-gray-600">Loading...</p>
                </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-4 sm:gap-6">
                        ...
                        <div class="md:w-1/2">
                            <div class="space-y-3 sm:space-y-4">
                                <div>
                                    <p class="text-xs sm:text-sm text-gray-500 mb-1">Item Name</p>
                                    <p class="text-base sm:text-lg font-semibold break-words" id="productName">-</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <p class="text-xs sm:text-sm text-gray-500 mb-1">Serial Number</p>
                                    <p class="text-sm sm:text-base break-all" id="productSerial">-</p>
                                </div>
                                <div>
                                    <p class="text-xs sm:text-sm text-gray-500 mb-1">Stock</p>
                        ...
                        <div class="md:w-1/2">
                            <div class="bg-gray-50 p-3 sm:p-4 rounded-lg">
                                ...
                                <div id="qrCodeContainer" class="flex flex-col items-center">
                                    <div class="bg-white p-2 sm:p-3 rounded shadow-sm mb-2 w-full max-w-[200px] sm:max-w-none">
                                        <!-- QR Code SVG will be loaded here -->
                                    </div>
                                    <p class="text-xs font-mono text-gray-600 break-all text-center" id="qrCodeText">-</p>
                                </div>
                                <button onclick="printModalQr()" 
                                        class="mt-3 w-full bg-blue-600 text-white px-3 py-2 rounded text-xs sm:text-sm hover:bg-blue-700 transition-colors">
                            ...
                            <div class="mt-4 bg-blue-50 p-3 rounded-lg">
                                <h5 class="font-semibold text-blue-900 text-xs sm:text-sm mb-2">How to Use:</h5>
                ...
                <div class="mt-4 border-t pt-3 sm:pt-4">
                    <button class="px-4 py-2 bg-gray-200 text-gray-800 text-sm font-medium rounded-md w-full sm:w-auto hover:bg-gray-300 transition-colors" 
                            onclick="closeModal()">
                        Close
                    </button>
                </div>
                ...
                .catch(error => {
                    ...
                    content.innerHTML = `
                        <div class="text-center py-8">
                            ...
                            <p class="mt-2 text-sm sm:text-base text-red-600">Failed to load item details</p>
                            <button onclick="closeModal()" class="mt-4 px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 text-sm">
                                Close
                            </button>
                        </div>
                    `;
