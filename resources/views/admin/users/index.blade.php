                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4 sm:p-6 text-gray-900">
                        ...
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4 sm:mb-6">
                            <h3 class="text-lg sm:text-xl font-medium">User List</h3>
                        ...
                        <div class="lg:hidden space-y-4">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                ...
                                <div class="flex justify-between items-start mb-3 pb-3 border-b border-gray-200">
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-base font-semibold text-gray-900 break-words mb-1">{{ $user->name }}</h4>
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="text-sm break-words">{{ $user->email }}</p>
                                </div>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    @else
                                        <div class="flex-1 flex items-center justify-center px-3 py-2 bg-gray-100 text-gray-500 text-xs font-medium rounded-lg">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="text-center py-12">
                                ...
                                <p class="mt-2 text-gray-500">No user data available.</p>
                            </div>
                            @endforelse
                        </div>
                    </div>
