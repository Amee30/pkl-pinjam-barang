                    ...
                    <div class="p-4 sm:p-6 text-gray-900 dark:text-white">
                        ...
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4 sm:mb-6">
                            <div class="flex items-center">
                                ...
                                <h3 class="text-lg sm:text-xl font-medium text-gray-900 dark:text-white">Item Movement History</h3>
                            </div>
                        ...
                        <div class="hidden lg:block overflow-x-auto">
                            <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Date</th>
                                        ...
                                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Type</th>
                                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Quantity</th>
                                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Source/Reason</th>
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900 dark:text-gray-300">
                                                @if($movement->type == 'in')
                                                    <strong class="dark:text-gray-200">Source:</strong> {{ $movement->source ?: '-' }}<br>
                                                @endif
                                                <strong class="dark:text-gray-200">Reason:</strong> {{ $movement->reason }}
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-1">No movement data yet</h3>
                                                <p class="text-sm text-gray-500 dark:text-gray-400">Start by adding your first movement.</p>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforelse
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                                ...
                                <div class="flex justify-between items-start mb-3">
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $movement->date->format('d/m/Y') }}</p>
                                    </div>
                                    <div>
                                        @if($movement->type == 'in')
                                ...
                                <div class="mb-3 pb-3 border-b border-gray-200 dark:border-gray-600">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Item Name</p>
                                    <p class="text-sm font-medium break-words text-gray-900 dark:text-white">{{ $movement->barang->nama_barang }}</p>
                                </div>

                                <!-- Quantity -->
                                <div class="mb-3">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Quantity</p>
                                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $movement->quantity }}</p>
                                </div>
                                ...
                                <div class="mb-3 pb-3 border-b border-gray-200 dark:border-gray-600">
                                    @if($movement->type == 'in' && $movement->source)
                                        <div class="mb-2">
                                            ...
                                            <p class="text-sm break-words text-gray-900 dark:text-gray-300">{{ $movement->source }}</p>
                                        </div>
                                    @endif
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Reason</p>
                                        <p class="text-sm break-words text-gray-900 dark:text-gray-300">{{ $movement->reason }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-end">
                                    <a href="{{ route('admin.movements.show', $movement->id) }}" 
                                       class="inline-flex items-center px-3 py-2 bg-blue-500 dark:bg-blue-600 hover:bg-blue-700 dark:hover:bg-blue-700 text-white text-xs font-semibold rounded-lg transition-colors">
