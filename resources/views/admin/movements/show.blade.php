            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-medium mb-6">Item Movement Details</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="border rounded-lg p-4">
                                ...
                                <div class="flex items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">Category: {{ $movement->barang->kategori }}</p>
                                        <p class="text-sm text-gray-600">Current Stock: {{ $movement->barang->stok }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="border rounded-lg p-4 mt-4">
                                <h4 class="text-md font-medium mb-4 border-b pb-2">Movement Information</h4>
                                
                                <div class="mb-2 flex">
                                    <span class="w-1/3 text-gray-600">Tipe:</span>
                                    <span class="w-2/3 font-medium">
                                        @if($movement->type == 'in')
                                            <span class="text-green-600 bg-green-100 px-2 py-1 rounded-full text-xs">In</span>
                                        @else
                                            <span class="text-red-600 bg-red-100 px-2 py-1 rounded-full text-xs">Out</span>
                                        @endif
                                    </span>
                                </div>
                                
                                <div class="mb-2 flex">
                                    <span class="w-1/3 text-gray-600">Quantity:</span>
                                    <span class="w-2/3 font-medium">{{ $movement->quantity }}</span>
                                </div>
                                
                                <div class="mb-2 flex">
                                    <span class="w-1/3 text-gray-600">Date:</span>
                                    <span class="w-2/3 font-medium">{{ $movement->date->format('d/m/Y') }}</span>
                                </div>
                                
                                @if($movement->type == 'in' && $movement->source)
                                <div class="mb-2 flex">
                                    <span class="w-1/3 text-gray-600">Source:</span>
                            ...
                            <div class="border rounded-lg p-4 md:col-span-2 mt-4">
                                <h4 class="text-md font-medium mb-4 border-b pb-2">Additional Information</h4>
                                
                                <div class="mb-2 flex">
                                    <span class="w-1/4 text-gray-600">Recorded By:</span>
                                    <span class="w-3/4 font-medium">{{ $movement->user->name }}</span>
                                </div>
                                
                                <div class="mb-2 flex">
                                    <span class="w-1/4 text-gray-600">Recording Time:</span>
                                    <span class="w-3/4 font-medium">{{ $movement->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                                
                                @if($movement->notes)
                                <div class="mb-2 flex">
                                    <span class="w-1/4 text-gray-600">Notes:</span>
