...
<head>
    ...
    <title>{{ config('app.name', 'InvenTrack') }} - Login</title>
    ...
    <div class="min-h-screen flex">
            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Sign in to access InvenTrack system
                    </p>
                </div>
                ...
                <div class="text-center text-sm text-gray-600 dark:text-gray-400">
                    <p>Don't have an account? <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">Sign up</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:flex lg:flex-1 bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-700 items-center justify-center p-12">
            <div class="max-w-lg text-center text-white space-y-6">
                ...
                <h1 class="text-4xl font-bold">InvenTrack System</h1>
                <p class="text-xl text-indigo-100">
                    Make Borrowing and Returning Inventory Easy and Efficient.
                </p>
            </div>
        </div>
    </div>
